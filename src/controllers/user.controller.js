...
export const createUser = async(req, res)=>{ 
    try {
        ...
        const [rows] = await pool.query('Insert into user(name,lastName, UserName,email,password,image, status,kind,create_at,update_at) values (?,?,?,?,?,?,?,?,?,?)',[name,lastName, UserName,email,password,image, status,kind,create_at,update_at])
        res.send({
            id: rows.insertId,
